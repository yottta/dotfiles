...
set-window-option -g window-status-activity-fg $tm_activity_fg_color
set-window-option -g window-status-activity-bg $tm_activity_bg_color
...
tm_date="#[fg=$tm_color_active] %d/%m/%Y %H:%M:%S | CPU: #(~/.dotfiles/common/bin/cpu_usage | head -1) | IP: #(~/.dotfiles/common/bin/iface | head -1)"
